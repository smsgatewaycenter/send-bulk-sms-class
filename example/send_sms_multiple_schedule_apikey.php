...
/**
 * SMSGatewayCenter - Send Schedule Multiple SMS with ApiKey Auth to SMSGateway.center API
 *
...
/**
 * Send Schedule Multiple SMS with ApiKey Auth.
 * Comma Separated mobile numbers.
 */
$scheduleTime = "2017-10-22 10:00:00"; //Schedule time is set to 22nd October 2017 at 10 am
$smsgatewaycenter = new psmplSMSGatewayCenter("", "","YourAPIKEY"); //Your apiKey (Login authentication with out userId and password)
